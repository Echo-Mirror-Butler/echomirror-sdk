...
responsibility. It complements
[SECURITY.md](https://github.com/Echo-Mirror-Butler/echomirror-sdk/blob/main/SECURITY.md),
which covers vulnerability reporting and supported versions.
